...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fec40929d5cc90015f53f06
...
To start editing your site, you can use the Sanity interface at https://panoramic-owl-c4092.sanity.studio/.
...
Generated at `2020-12-30T09:14:54.044Z` by Stackbit version `0.3.42`.